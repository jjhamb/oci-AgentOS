#!/usr/bin/env python3
"""Generate EC Minutes DOCX — v4, corrected per Capt Jhamb's final version."""
...
# ══════════════════════════════════════════════
# SIGNATORY BLOCK — single row, visible borders
# ══════════════════════════════════════════════
...
add_run(p_left3, 'Mobile: 8826055558', font_size=10)
